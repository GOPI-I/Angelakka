...
app.put("/jokes/:id",(req,res)=>{
  const serachId = parseInt(req.params.id);
  const newUpdatedJoek = {
    id : serachId,
    jokeText : req.body.text,
    jokeType : req.body.type,
  };

  const indexJoke = jokes.findIndex((joke)=> joke.id === serachId);
  jokes[indexJoke] = newUpdatedJoek;
  res.json(newUpdatedJoek);
